...
class WelcomeMessage {
    ...
    public function __construct($username) {
         if (isset($username)) {
            ...
            $this->username = "vizitator";
      }
    }

    public function getWelcomeMessage() {
        return "Bine ai venit, " . $this->username . "!";
    }
}
if (isset($_SESSION['username'])) {
   $welcome_message = new WelcomeMessage($_SESSION['username']);
} else {
   // Dacă nu există nicio sesiune, inițializăm cu "vizitator"
   $welcome_message = new WelcomeMessage(null);
}
$welcome_text = $welcome_message->getWelcomeMessage(); // Obține mesajul de bun venit
...
class Bike {
   ...
   public function __construct($id, $brand, $model, $size, $color, $description, $pret, $image) {
       $this->id = $id;
       $this->brand = $brand;
       $this->model = $model;
       $this->size = $size;
...
<div class="cycle_section layout_padding">
    <div class="container">
        ...
        <?php
        // Creare obiect BikeManager
        $bikeManager = new BikeManager($con);

        // Obține bicicletele
        $bikes = $bikeManager->getBikes();

        // Iterează prin fiecare bicicletă
        ...
        ?>
            <div class="cycle_section_2 layout_padding">
                <div class="row">
                    <div class="col-md-6">
                        <div class="box_main">
                            <h6 class="number_text"><?php echo $bike->getId(); ?></h6>
                            <div class="image_2"><img src="<?php echo $bike->getImage(); ?>"></div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <h1 class="cycles_text"><?php echo $bike->getBrand(); ?></h1>
                        <p class="lorem_text">Tip:       <?php echo $bike->getModel(); ?></p>
                        <p class="lorem_text">Marime:    <?php echo $bike->getSize(); ?></p>
                        <p class="lorem_text">Culoare:   <?php echo $bike->getColor(); ?></p>
                        <p class="lorem_text"><?php echo $bike->getDescription(); ?></p>
                        <div class="btn_main">
                            <div class="buy_bt"><a href="contact.php">Buy now!</a></div>
                            <h4 class="price_text">Pret <span style=" color: #f7c17b">$</span> <span style=" color: #325662"><?php echo $bike->getPret(); ?></span></h4>
                        </div>
                    </div>
                </div>
            </div>
...
<!-- cycle section end -->
      ...
      <div class="about_section layout_padding">
         <div class="container">
            ...
            <image href="images/logo2.png" width="100" height="100">
               <animate
                  attributeName="x"
                  begin="0s"
                  dur="8s"
