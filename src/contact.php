...
// Funcția pentru validarea datelor
...
$numeErr = $emailErr = $telefonErr = $messageErr = ""; // Variabile pentru mesajele de eroare
$nume = $email = $telefon = $message = ""; // Variabile pentru datele introduse în formular

if(isset($_POST["submit"])) { // Verificăm dacă formularul a fost trimis
   // Verificăm numele
   if(empty($_POST["name"])) {
       $numeErr = "Name is required";
   } else {
       $nume = test_input($_POST["name"]);
       // Verificăm dacă numele conține doar litere și spații
   ...
   if(empty($_POST["phone"])) {
       $telefonErr = "Phone number is required";
   } else {
       $telefon = test_input($_POST["phone"]);
       // Verificăm dacă numărul de telefon conține doar cifre și are exact 10 caractere
       if (!preg_match("/^[0-9]{10}$/",$telefon)) {
           $telefonErr = "Invalid phone number";
       }
   }
   ...
   if(empty($numeErr) && empty($emailErr) && empty($telefonErr) && empty($messageErr)) {
   
       $sql = "INSERT INTO contact_messages(name, email, phone, message) VALUES ('$nume', '$email', '$telefon', '$message')";
      ...
      <div class="contact_main">
         ...
         <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            <div class="form-group">
               <input type="text" class="email-bt" placeholder="Name" name="name" value="<?php echo $nume; ?>">
               <span class="error">* <?php echo $numeErr;?></span>
            </div>
            <div class="form-group">
               <input type="text" class="email-bt" placeholder="Email" name="email" value="<?php echo $email; ?>">
               <span class="error">* <?php echo $emailErr;?></span>
            </div>
            <div class="form-group">
               <input type="text" class="email-bt" placeholder="Phone Number" name="phone" value="<?php echo $telefon; ?>">
               <span class="error">* <?php echo $telefonErr;?></span>
            </div>
            <div class="form-group">
               <textarea class="massage-bt" placeholder="Message" rows="5" id="comment" name="message"><?php echo $message; ?></textarea>
               <span class="error">* <?php echo $messageErr;?></span>
            </div>
            <div class="g-recaptcha" data-sitekey="6LfReNApAAAAADqBzDzn_waGzeMoWWlBJkRM91hH" name="g-recaptcha"></div>
         ...
         <div class="container-fluid">
            <div class="row">
               ...
               <div class="col-lg-4 col-sm-12">
                  <div class="call_text"><a href="#"><img src="images/call-icon.png"><span class="padding_left_0">Call Now 123467890</span></a></div>
                  <div class="call_text"><a href="#"><img src="images/mail-icon.png"><span class="padding_left_0">biciclete@gmail.com</span></a></div>
