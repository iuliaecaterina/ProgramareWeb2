 ...
 <div class="banner_section layout_padding">
   ...
   <div class="about_section layout_padding">
      <div class="container">
         ...
         <p class="about_text">Suntem o echipă de pasionați ai ciclismului, dedicați să împărtășim bucuria și libertatea pe două roți. Cu ani de experiență în spate și o dragoste profundă pentru ceea ce facem, ne străduim să oferim clienților noștri cele mai bune produse și servicii.</p>
         ...
         <div id="mapContainer">
    <img id="mapImage" src="images/map.png" alt="Map Image">
    <canvas id="bikeCanvas"></canvas>
</div>

<script>
    // Coordonatele traseului bicicletei
    var bikeRoute = [
        { x: 40, y: 40 },
        { x:200, y: 55 },
        { x:230, y: 80 },
    ...
    // Funcția pentru a desena traseul bicicletei pe canvas
    function drawBikeRoute() {
        ctx.clearRect(0, 0, canvas.width, canvas.height);
        ctx.beginPath();
        ctx.moveTo(bikeRoute[0].x, bikeRoute[0].y);
        for (var i = 1; i < bikeRoute.length; i++) {
            ctx.lineTo(bikeRoute[i].x, bikeRoute[i].y);
        }
        ctx.strokeStyle = "red"; 
        ctx.lineWidth = 3; 
        ctx.stroke();
         ...
         <div class="row">
            ...
            <div class="col-lg-4 col-sm-12">
               ...
               <div class="call_text"><a href="#"><img src="images/mail-icon.png"><span
                        class="padding_left_0">bicilete@gmail.com</span></a></div>
